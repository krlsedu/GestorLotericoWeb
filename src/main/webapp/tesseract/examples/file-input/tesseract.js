...
var defaultOptions = {
    ...
    corePath: 'http://localhost:8080/GestorLotericoWeb/tesseract/examples/file-input/index.js',
...
if (process.env.NODE_ENV === "development") {
    ...
    defaultOptions.workerPath = 'http://localhost:8080/GestorLotericoWeb/tesseract/examples/file-input/worker.js';
}
